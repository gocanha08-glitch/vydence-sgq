...
const ALLP=['dashboard','usuarios.gerenciar','grupos.gerenciar','auditoria.ver','ro.abrir','ro.analisar','ro.aprovar','ro.fechar','ro.excluir','nc.abrir','nc.analisar','nc.aprovar','nc.fechar','nc.excluir','riacp.abrir','riacp.analisar','riacp.aprovar','riacp.fechar','riacp.excluir','sa.abrir','sa.analisar','sa.aprovar','sa.fechar','sa.excluir'];
