...
const ALLP=['dashboard','indicators','users','usuarios.gerenciar','usuarios.importar','grupos.ver','grupos.gerenciar','auditoria.ver','config.criticidades','config.matriz','config.perguntas','config.prazos','produtos.ver','produtos.gerenciar','sa.avaliacao_inicial','sa.criar','sa.ver_todas','sa.aprovacao_plano','sa.concluir','sa.cancelar','sa.abrir','sa.analisar','sa.aprovar','sa.fechar','sa.excluir','ro.abrir','ro.analisar','ro.tratar_segregado','ro.aprovar_concessao','ro.aprovar_correcao','ro.aprovar','ro.cancelar','ro.reabrir','ro.fechar','ro.excluir','ro.ver_todas','nc.abrir','nc.tratar_itens','nc.aprovar_concessao','nc.gerenciar_acoes','nc.concluir_acao','nc.analisar','nc.aprovar','nc.fechar','nc.cancelar','nc.reabrir','nc.excluir','nc.ver_todas','riacp.abrir','riacp.analisar','riacp.aprovar','riacp.fechar','riacp.excluir','riacp.ver_todas'];
